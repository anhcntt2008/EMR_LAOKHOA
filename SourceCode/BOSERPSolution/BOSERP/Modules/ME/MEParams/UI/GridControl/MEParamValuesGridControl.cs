...
{
    public partial class MEParamValuesGridControl : BOSGridControl
    {
        ...
        protected override DevExpress.XtraGrid.Views.Grid.GridView InitializeGridView()
        {
            ...
            GridColumn column = gridView.Columns["MEParamValueKey"];
            if (column != null)
            {
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((MEParamsModule)Screen.Module).DeleteParamFromValuesList();
            }
        }
