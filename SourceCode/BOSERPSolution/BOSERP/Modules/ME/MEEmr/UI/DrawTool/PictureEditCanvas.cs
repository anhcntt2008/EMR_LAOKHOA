...
namespace BOSERP.Modules.MEEmr
{
    ...
    sealed public class PictureEditCanvas : PictureEdit
    {
        ...
        /// Drawing mode flag
        /// </summary>
        public bool _IsDrawingMode;

        /// <summary>
        /// Current Shape to be drawn onto this PictureEditCanvas
        /// </summary>
        public IDrawShapes CurrentShape = null;

        /// <summary>
        /// Collection of Shapes to be drawn onto this PictureEditCanvas
        /// </summary>
        public IList<IDrawShapes> Shapes = new List<IDrawShapes>();
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (IsDesignMode == false && CurrentShape != null)
            {
                ...
                //Turn off Drawing Mode -- uthv not turn off can continous
                //_IsDrawingMode = false;
                // Cursor = Cursors.Default;
            }
