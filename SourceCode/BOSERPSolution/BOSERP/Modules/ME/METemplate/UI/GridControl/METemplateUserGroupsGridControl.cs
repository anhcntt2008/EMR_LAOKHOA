...
{
    public partial class METemplateUserGroupsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            METemplateEntities entity = (METemplateEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.METemplateUserGroupList;
            this.DataSource = bds;
        }
        ...
        protected override DevExpress.XtraGrid.Views.Grid.GridView InitializeGridView()
        {
            ...
            GridColumn column = gridView.Columns["FK_ADUserGroupID"];
            if (column != null)
            {
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((METemplateModule)Screen.Module).DeleteTemplateUserGroupList();
            }
        }
    }
}
