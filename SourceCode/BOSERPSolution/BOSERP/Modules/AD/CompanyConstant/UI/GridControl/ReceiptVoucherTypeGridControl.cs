...
{
    public partial class ReceiptVoucherTypeGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.ReceiptVoucherTypeList;
            this.DataSource = bds;
        }
        ...
        protected override void GridView_ValidatingEditor(object sender, BaseContainerValidateEditorEventArgs e)
        {
            ...
            if (e.Value != null)
            {
                if (gridView.FocusedColumn.FieldName == "ADConfigText")
                {
                    ...
                    {
                        e.ErrorText = CompanyConstantLocalizedResources.ReceiptVoucherTypeIsRequiredMessage.ToString();
                        e.Valid = false;
                    }
                }
            }
        ...
        protected override void GridView_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            {
                ((CompanyConstantModule)Screen.Module).RemoveSelectedReceiptVoucherType();
            }
        }
    }
}
