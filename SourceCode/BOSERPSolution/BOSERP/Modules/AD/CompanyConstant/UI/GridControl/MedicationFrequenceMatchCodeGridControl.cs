...
{
    public partial class MedicationFrequenceMatchCodeGridControl : BOSComponent.BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            CompanyConstantEntities entity = (CompanyConstantEntities)((BaseModuleERP)Screen.Module).CurrentModuleEntity;
            BindingSource bds = new BindingSource();
            bds.DataSource = entity.MedicationFrequenceList;
            this.DataSource = bds;
        }
        ...
        protected void GridView_ValidatingEditor(object sender, BaseContainerValidateEditorEventArgs e)
        {
            ...
            if (e.Value != null)
            {
                if (gridView.FocusedColumn.FieldName == "ADMatchCodeValue")
                {
                    ...
                    {
                        e.ErrorText = CompanyConstantLocalizedResources.NotNullOrEmptyMedicationFrequenceMessage.ToString();
                        e.Valid = false;
                    }
                    else
                    {
                        ...
                        {
                            ((CompanyConstantModule)Screen.Module).CheckMatchCodeValues(MatchCodeMedicine.MEMedicationItemMatchCodeFrequence.ToString(),
        ...
        protected override void GridView_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            {
                ((CompanyConstantModule)Screen.Module).RemoveSelectedMedicationFrequence();
            }
        }
    }
}
