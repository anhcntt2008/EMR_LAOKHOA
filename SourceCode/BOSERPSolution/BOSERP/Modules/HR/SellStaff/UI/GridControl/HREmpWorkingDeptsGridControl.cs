...
{
    public partial class HREmpWorkingDeptsGridControl : BOSGridControl
    {
        public override void InitGridControlDataSource()
        {
            ...
            {
                DataSource = entity.EmpWorkingDeptList
            };
            DataSource = bds;
        }
        ...
        protected override DevExpress.XtraGrid.Views.Grid.GridView InitializeGridView()
        {
            ...
            //column = gridView.Columns["HREmpWorkingDeptFrom"];
            //if (column != null)
            //    column.OptionsColumn.AllowEdit = true;
            //column = gridView.Columns["HREmpWorkingDeptRemark"];
            //if (column != null)
            //    column.OptionsColumn.AllowEdit = true;
            return gridView;
        }
