...
{
    public partial class BOSDockControlContainer : ControlContainer, IBOSControl
    {
        #region Variables
        ...
        #region Contructor
        public BOSDockControlContainer()
        {
            InitializeComponent();
        }

        public BOSDockControlContainer(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
