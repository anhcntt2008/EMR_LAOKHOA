...
#define STPAD_ERROR_RSAUNKNOWN			(-41L)
#define STPAD_ERROR_RSANOCERTCHAIN      (-44L)
#define STPAD_ERROR_KEYPADSET			(-45L)
#define STPAD_ERROR_NOTTIMEVALID        (-46L)
#define STPAD_ERROR_ISREVOKED           (-47L)
#define STPAD_ERROR_NOTSIGNATUREVALID   (-48L)
...
#define STPAD_ERROR_RSANOPASSLENGTH		(-98L)
#define STPAD_ERROR_INVALIDTARGET		(-99L)
...
extern "C" STPADLIB_API LONG STControlSetLogDirectory(LPCWSTR szPath, LONG nOptions = STPAD_LOG_STPADLIB);
...
extern "C" STPADLIB_API LONG STDisplaySetStandbyImageEx(HBITMAP hBitmap, LONG nDuration);
#endif
extern "C" STPADLIB_API LONG STDisplaySetStandbyImageFromFile(LPCWSTR szPath);
extern "C" STPADLIB_API LONG STDisplaySetStandbyImageFromFileEx(LPCWSTR szPath, LONG nDuration);
...
extern "C" STPADLIB_API LONG STSensorAddKeypadHotSpot(LONG nLeft, LONG nTop, LONG nWidth, LONG nHeight, LPCWSTR szChars);
extern "C" STPADLIB_API LONG STSensorAddScrollHotSpot(LONG nLeft, LONG nTop, LONG nWidth, LONG nHeight, HOTSPOTTYPE nType);
...
extern "C" STPADLIB_API LONG STSensorGetKeypadEntries(LPCWSTR szEntries, LONG* pnStringLength, LONG nMaxEntries);
extern "C" STPADLIB_API LONG STSensorClearKeypadEntries();
#ifdef _WINDOWS
...
extern "C" STPADLIB_API LONG STRSASignPw(BYTE* pbtSignature, LONG* pnSize, RSASCHEME nScheme, HASHVALUE nHashValue, LONG nOptions, LPCWSTR szSignPassword);
...
extern "C" STPADLIB_API LONG STRSAExtractExtraData(EXTRADATA* pExtraData, BYTE* pbtSignData = NULL, LONG nSignDataSize = 0);
extern "C" STPADLIB_API LONG STRSASetSignPassword(LPCWSTR szNewPassword, LPCWSTR szOldPassword, LONG nMaxWrongEntries);
extern "C" STPADLIB_API LONG STRSAGetSignPasswordLength();
extern "C" STPADLIB_API void STRSASetSignPasswordLength(LONG nPasswordLength);
...
extern "C" STPADLIB_API LONG __stdcall STControlSetLogDirectory_stdcall(LPCWSTR szPath, LONG nOptions = STPAD_LOG_STPADLIB);
...
extern "C" STPADLIB_API LONG __stdcall STDisplaySetStandbyImageEx_stdcall(HBITMAP hBitmap, LONG nDuration);
extern "C" STPADLIB_API LONG __stdcall STDisplaySetStandbyImageFromFile_stdcall(LPCWSTR szPath);
extern "C" STPADLIB_API LONG __stdcall STDisplaySetStandbyImageFromFileEx_stdcall(LPCWSTR szPath, LONG nDuration);
...
extern "C" STPADLIB_API LONG __stdcall STSensorAddKeypadHotSpot_stdcall(LONG nLeft, LONG nTop, LONG nWidth, LONG nHeight, LPCWSTR szChars);
extern "C" STPADLIB_API LONG __stdcall STSensorAddScrollHotSpot_stdcall(LONG nLeft, LONG nTop, LONG nWidth, LONG nHeight, HOTSPOTTYPE nType);
...
extern "C" STPADLIB_API LONG __stdcall STSensorGetKeypadEntries_stdcall(LPCWSTR szEntries, LONG* pnStringLength, LONG nMaxEntries);
extern "C" STPADLIB_API LONG __stdcall STSensorClearKeypadEntries_stdcall();
...
extern "C" STPADLIB_API LONG __stdcall STRSASignPw_stdcall(BYTE* pbtSignature, LONG* pnSize, RSASCHEME nScheme, HASHVALUE nHashValue, LONG nOptions, LPCWSTR szSignPassword);
...
extern "C" STPADLIB_API LONG __stdcall STRSAExtractExtraData_stdcall(EXTRADATA* pExtraData, BYTE* pbtSignData = NULL, LONG nSignDataSize = 0);
extern "C" STPADLIB_API LONG __stdcall STRSASetSignPassword_stdcall(LPCWSTR szNewPassword, LPCWSTR szOldPassword, LONG nMaxWrongEntries);
extern "C" STPADLIB_API LONG __stdcall STRSAGetSignPasswordLength_stdcall();
extern "C" STPADLIB_API void __stdcall STRSASetSignPasswordLength_stdcall(LONG nPasswordLength);
