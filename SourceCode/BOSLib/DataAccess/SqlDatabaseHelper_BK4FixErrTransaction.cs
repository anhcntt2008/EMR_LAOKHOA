    ...
    public class SqlDatabaseHelper
    {
        ...
        static SqlDatabaseHelper()
        {
            try
            {
                ...
                ForeignTableColumns = new SortedList<string, DataColumnCollection>();
            }
            catch (Exception ex)
            {
        ...
        //    {
        //        strPrimaryKeyColumn = strTableName + "ID";
        //    }
        //    else
        //    {                   
        ...
        //        {
        //            strPrimaryKeyColumn = strTableName.Substring(0, strTableName.Length - 3) + "yID";
        //        }
        //        else
        //        {
        //            strPrimaryKeyColumn = strTableName.Substring(0, strTableName.Length - 1) + "ID";
        //        }
        //    }
