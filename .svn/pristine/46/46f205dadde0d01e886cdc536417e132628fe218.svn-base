...
/****** Object:  StoredProcedure [dbo].[MEEmrs_Search]    Script Date: 6/16/2020 10:39:29 AM ******/
SET ANSI_NULLS ON
GO
...
-- Modified date: 15/06/2020 by XuanTM - add patientGroup, fromDateOut, toDateOut
-- ======================================================================
...
SET NOCOUNT ON
	...
	WHERE  (@MEEmrNo IS NULL OR e.MEEmrNo LIKE ''%'' + @MEEmrNo + ''%'')
		...
		AND (@MEEmrDateOutFrom IS NULL OR CONVERT(date, e.MEEmrDateOut) BETWEEN @MEEmrDateOutFrom AND @MEEmrDateOutTo)
