...
{
    public partial class ClasColorPicker : DevExpress.XtraEditors.ColorPickEdit, IBOSControl
    {
        #region Variables
        ...
        #region Constructor
        public ClasColorPicker()
        {
            InitializeComponent();

            Size = new Size(150, 20);

            Properties.ColorText = DevExpress.XtraEditors.Controls.ColorText.Native;
            Properties.StoreColorAsInteger = true;
        }

        public ClasColorPicker(IContainer container)
        {
            container.Add(this);
