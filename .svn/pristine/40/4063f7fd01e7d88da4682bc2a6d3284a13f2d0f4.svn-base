...
{
    public partial class BOSMemoEdit : DevExpress.XtraEditors.MemoEdit, IBOSControl
    {
        #region Variables
        ...
        public BOSMemoEdit(IContainer container)
        {
            container.Add(this);
        ...
        {
            BOSControlUtil.SetControlCommonProperties(this, objFieldInfo);
            this.Properties.ReadOnly = objFieldInfo.STFieldReadOnly;
            this.Properties.ScrollBars = (ScrollBars)Enum.Parse(typeof(ScrollBars), objFieldInfo.STFieldScrollBars);
