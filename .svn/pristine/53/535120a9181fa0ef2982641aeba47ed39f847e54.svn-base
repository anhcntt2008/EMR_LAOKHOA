GO
/****** Object:  StoredProcedure [dbo].[MEEmrSums_Search]    Script Date: 9/5/2021 10:59:14 PM ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON
	...
	SET @sql = 'SELECT TOP 100000 es.*
				...
				AND (@MEEmrSumCode IS NULL OR es.MEEmrSumCode = @MEEmrSumCode)
				AND (@MEEmrSumStoreCode IS NULL OR es.MEEmrSumStoreCode = @MEEmrSumStoreCode)
