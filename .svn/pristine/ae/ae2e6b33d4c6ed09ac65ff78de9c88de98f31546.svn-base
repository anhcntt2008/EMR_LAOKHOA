...
namespace Clas.Emr.Ipc.Net.Messaging
{
    ...
    /// </summary>
    public sealed class IpcListener : NativeWindow
    {
        /// <summary>
        ...
        public delegate void IpcMessageHandler(object sender, IpcMessageEventArgs e);
        /// <summary>
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            if (msg.Msg == Win32.WM_COPYDATA)
            {
                ...
                MessageReceived(this, new IpcMessageEventArgs(dataGram));
            }
        }
        /// <summary>
        ...
        {
            return string.Format("Ipc.Net.Services.{0}", channelName);
        }
    }
}
