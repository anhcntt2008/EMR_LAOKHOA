...
{
    public partial class BOSChartControl : DevExpress.XtraCharts.ChartControl, IBOSControl
    {
        #region Variables
        ...
        #region Constructor
        public BOSChartControl()
        {
            InitializeComponent();
        }

        public BOSChartControl(IContainer container)
        {
            container.Add(this);
        ...
        private void BOSChartControl_BoundDataChanged(object sender, EventArgs e)
        {
            foreach (Series sr in Series)
            {
