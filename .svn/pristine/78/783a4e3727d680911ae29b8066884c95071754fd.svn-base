...
{
    public partial class guiEmrs : BOSERPScreen
    {
        public List<MEEmrsInfo> _emrs { get; private set; }
        
        public guiEmrs(List<MEEmrsInfo> emrs)
        {
            InitializeComponent();
            _emrs = emrs;
        }
        private void Emrs_Load(object sender, EventArgs e)
        {
            this.KeyPreview = true;
            var grid = this.grcEmrs.MainView as GridView;
            ...
            this.grcEmrs.DataSource = _emrs;
            this.grcEmrs.RefreshDataSource();
            this.grcEmrs.Refresh();
        }
