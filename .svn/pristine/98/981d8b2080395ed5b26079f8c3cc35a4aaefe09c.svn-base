...
namespace BOSERP.Modules.MEEmr.UI
{
    ...
    /// Lien Ket Benh An
    /// </summary>
    public partial class guiSelectEmrRelation : BOSERPScreen
    {
        ...
        public void Ok()
        {
            ...
            if (grid.FocusedRowHandle >= 0)
            {
                ...
                this.SelectedEmrRelationFromName = guiSelectEmrRelation_fld_lkeMEEmrRelationFromName.EditValue.ToString();
