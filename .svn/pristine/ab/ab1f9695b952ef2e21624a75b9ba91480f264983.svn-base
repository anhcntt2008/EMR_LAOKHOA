...
{
    public partial class BOSPivotGridControl : DevExpress.XtraPivotGrid.PivotGridControl, IBOSControl
    {
        #region Variables
        ...
        #region Constructor
        public BOSPivotGridControl()
        {
            InitializeComponent();
        }

        public BOSPivotGridControl(IContainer container)
        {
            container.Add(this);
