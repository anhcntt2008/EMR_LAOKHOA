        ...
        private void guiDocumentPreview_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(_mode))
                    filePath = (this.Module as MEEmrManageModule).DownloadFtpFile(_document);
                else
                {
                    ...
                    filePath = (this.Module as MEEmrManageModule).DownloadFtpFileCommon(serverPath, fileName, localPart);
                }
