...
/****** Object:  StoredProcedure [dbo].[MEEmrs_Search]    Script Date: 12/21/2020 1:36:15 PM ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON
	...
	begin
		...
		set @sqlMEEmrArchives = ' OUTER APPLY (SELECT TOP 1 MEEmrArchiveStatus FROM MEEmrArchives arc WHERE arc.AAStatus=''Alive'' AND arc.FK_MEEmrID = e.MEEmrID ORDER BY MEEmrArchiveID desc) arcap'
	end
	-- End MEEmrArchives
