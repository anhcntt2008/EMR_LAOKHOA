...
GO
DELETE FROM ADConfigValues where ADConfigKeyGroup = 'ObjectHistoryAction' and ADConfigKey = 'ObjectHistoryActionCreate'
INSERT INTO [dbo].[ADConfigValues] VALUES 
((SELECT MAX(ADConfigValueID)+1 FROM [ADConfigValues]), 
 'Alive', N'ObjectHistoryActionCreate', N'Create', N'Tạo Mới', NULL, N'ObjectHistoryAction', '1');
GO
