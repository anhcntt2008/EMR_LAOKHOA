...
WHERE STToolbarFunctionName = 'EmrSumXML'
	AND STToolbarFunctionClass = 'BOSERP.Modules.MEEmr.MEEmrManage'

DELETE
FROM [dbo].[STToolbars]
WHERE STToolbarName = 'fld_barbtnEmrSumXML'
...
VALUES (
	...
	,'EmrSumXML'
	,'Void EmrSumXML()'
	,'BOSERP.Modules.MEEmr.MEEmrManage'
	,1
	);
